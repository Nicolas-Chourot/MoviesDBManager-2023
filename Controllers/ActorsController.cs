...
namespace MoviesDBManager.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public ActionResult ActorForm(Actor actor)
        {
        ...
        [HttpPost]
        public ActionResult Create(Actor actor, List<int> SelectedItems)
        {
            if (ModelState.IsValid)
            {
                DB.Actors.Add(actor, SelectedItems);
        ...
        [HttpPost]
        public ActionResult Edit(Actor actor, List<int> SelectedItems)
        {
            if (ModelState.IsValid)
            {
                DB.Actors.Update(actor, SelectedItems);
                return RedirectToAction("Index");
            }
